    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col content-center items-center justify-center">
        <div className="flex row align-baseline space-x-3">
          <p className="text-sm text-main align-baseline uppercase">
            custom rings
          </p>
          <p className="text-2xl text-main align-baseline font-noto italic">
            made just for you
          </p>
        </div>
        <Link href="/categorie">
        ...
        >
          <div className="flex flex-col items-center justify-center">
            <Link href="/categorie">
              ...
              <div className="w-full h-20 relative">
                <Image
                  src="/eternity_solitaire_engagement.webp"
                  alt=""
                  width={400}
                  height={400}
                  className="w-full h-full object-contain"
